...
create view v_fill_station as select * from gas_station right join fillup using (gs_id);


drop view if exists v_fillup;
create view `v_fillup` AS select * from gas_brand right join v_fill_station using (gb_id);
